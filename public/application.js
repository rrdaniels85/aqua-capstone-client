...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tankEvents = __webpack_require__(38);
	var animalEvents = __webpack_require__(39
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var tankapi = __webpack_require__(12);
	var tankui = __webpack_require__(13);
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  $('#signinmodal').modal('toggle');
	  tankapi.getTanks().then(tankui.getTanksSuccess).catch(tankui.getTanksFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createTank = function createTank(data) {
	  return $.ajax({
	...
	var getTanks = function getTanks() {
	  return $.ajax({
	    url: config.apiOrigin + '/tanks',
	    method: 'GET',
	    headers: {
	...
	var getOneTank = function getOneTank(tankId) {
	  return $.ajax({
	...
	var deleteTank = function deleteTank(data) {
	  return $.ajax({
	...
	var updateTank = function updateTank(tankId, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/tanks/' + tankId,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var listTanksTemplate = __webpack_require__(14);
	var showOneTankTemplate = __webpack_require__(34);
	var showTanksTitleTemplate = __webpack_require__(36);
	var noTanksTemplate = __webpack_require__(37);

	var createTankSuccess = function createTankSuccess(data) {
	  // toggle modal
	...
	var getTanksSuccess = function getTanksSuccess(data) {
	  ...
	  if (data.tanks.length === 0) {
	    ...
	    );var _showTankTitle = showTanksTitleTemplate();
	    $('#handlebarsone').html(_showTankTitle);
	    var listTanks = listTanksTemplate({ tanks: data.tanks });
	    $('#handlebarstwo').html(listTanks);
	  }
	};

	var getTanksFailure = function getTanksFailure() {};

	var updateTankSuccess = function updateTankSuccess(data) {
	  // toggle modal
	...
	var updateTankFailure = function updateTankFailure() {
	...
	var deleteTankSuccess = function deleteTankSuccess(data) {
	  // toggle modal
	...
	var deleteTankFailure = function deleteTankFailure() {};

	var getOneTankSuccess = function getOneTankSuccess(data) {
	  ...
	  ();var showOneTank = showOneTankTemplate({ tank: data.tank });
	...
	var getOneTankFailure = function getOneTankFailure() {};

	var refreshOneTankSuccess = function refreshOneTankSuccess(data) {
	...
	var refreshOneTankFailure = function refreshOneTankFailure() {};

	module.exports = {
	  createTankSuccess: createTankSuccess,
	  createTankFailure: createTankFailure,
	  getTanksSuccess: getTanksSuccess,
	  getTanksFailure: getTanksFailure,
	  updateTankSuccess: updateTankSuccess,
	  updateTankFailure: updateTankFailure,
	  deleteTankSuccess: deleteTankSuccess,
	  deleteTankFailure: deleteTankFailure,
	  getOneTankSuccess: getOneTankSuccess,
	  getOneTankFailure: getOneTankFailure,
	  refreshOneTankSuccess: refreshOneTankSuccess,
	  refreshOneTankFailure: refreshOneTankFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- Don't uncomment yet -->\n<div class=\"row\">\n  <div class=\"col-sm-4 col-sm-offset-4 tank-listing\">\n  <h3 class =\"text-center tank-names\" data-id=\""
	    ...
	    + "</h1>\n  <div class=\"text-center\">\n      <ul class=\"list-unstyled\"><li class=\"tank-water\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Water Type: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.water : stack1), depth0))
	    + "</li>\n        <li>\n          <button type=\"button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-primary handle manage-tank\">Manage Aquarium</button>\n        </li>\n      </ul>\n</div>\n</div>\n</div>\n<br>\n<br>\n<br>\n\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.tanks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "              <option disabled value>--Choose a Water Type (Required)--</option>\n              <option value=\"Fresh\">Fresh</option>\n              <option value=\"Salt\">Salt</option>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "<div class=\"single-tank-view tank-style\">\n  <br>\n<h1><strong> Aquarium Name: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</strong></h1>\n<h2>Water Type: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.water : stack1), depth0))
	    + "</h2>\n<button type=\"button\" class=\"btn btn-large btn-success\" id=\"createanimalbutton\" data-toggle=\"modal\" data-target=\"#createanimalmodal\">\n    Add Animal to this Aquarium!\n  </button>\n  <button type=\"button\" class=\"update btn btn-primary update-tank-button\" data-toggle=\"modal\" data-target=\"#updatetankmodal"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">Update Aquarium Details</button>\n  <button type=\"button\" class=\"remove btn btn-danger handle\" data-toggle=\"modal\" data-target=\"#removetankmodal"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">Delete Aquarium</button>\n  <button type=\"button\" class=\"btn btn-info\" id=\"show-all-tanks\">Return to List of My Aquariums</button>\n  <hr>\n  <!-- ADD TANK MODAL-->\n  <div class=\"modal fade\" id=\"createanimalmodal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Add a Critter to This Aquarium</h5>\n      </div>\n      <div class=\"modal-body\">\n        <p>*You must complete all fields in order to add an animal.</p>\n  <form id=\"create-animal\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <fieldset>\n    <legend>Add An Animal</legend>\n    <input type='text' name='animal[name]' id ='create-animal-name' maxlength=\"60\" placeholder=\"Enter Name\" required>\n    <input type='text' name='animal[species]' id ='create-animal-species' maxlength=\"60\" placeholder=\"Enter Species\" required>\n    <input type='text' name='animal[color]' id ='create-animal-color' maxlength=\"60\" placeholder=\"Enter Color\" required>\n    <hr>\n    <input data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Add Animal\">\n  </fieldset>\n  </form>\n  </div>\n  <div class=\"modal-footer\">\n  <div class=\"createerror\"></div>\n  <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n  </div>\n  </div>\n  </div>\n  </div>\n  </div>\n\n  <div class=\"modal fade update-tank-modal\" id=\"updatetankmodal"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Update Aquarium Information</h5>\n        </div>\n        <div class=\"modal-body\">\n           <p>*You must complete all fields in order to update an aquarium</p>\n          <form class=\"update-tank\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n          <fieldset>\n            <input type='text' name='tank[name]' id ='updateName' maxlength=\"60\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.name : stack1), depth0))
	    + "\" placeholder=\"Updated Name\" required>\n            <select name=\"tank[water]\" required>\n"
	    + ((stack1 = __default(__webpack_require__(35)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.water : stack1),{"name":"dropdown","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "              </select>\n              <hr>\n            <input data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Update Aquarium\">\n        </fieldset>\n        </form>\n        </div>\n        <div class=\"modal-footer\">\n          <div class=\"updateerror\"></div>\n          <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n        </div>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"modal fade\" id=\"removetankmodal"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <h4 class=\"modal-title\" id=\"exampleModalLongTitle\">Are you sure you want to delete this aquarium?</h4>\n        </div>\n        <div class=\"modal-body\">\n          <legend>Aquarium Name: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</legend>\n          <h4>**Please note that by deleting this aquarium, you will also be deleting any animals listed inside this aquarium.</h4>\n          <form class=\"remove-tank\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.tank : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <fieldset>\n              <input type=\"submit\" name=\"submit\" value=\"Proceed With Deleting Aquarium\">\n            </fieldset>\n          </form>\n        </div>\n        <div class=\"modal-footer\">\n          <div class=\"passworderror\"></div>\n          <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"tank-title\" class=\"tank-style\">\n  <br>\n<h1>Welcome!</h1>\n<h2>My Aquariums</h2>\n  <button type=\"button\" class=\"btn btn-large btn-success afterlogin\" id=\"createtankbutton\" data-toggle=\"modal\" data-target=\"#createtankmodal\">\n    Create New Aquarium!\n  </button>\n  <hr>\n  <!-- ADD TANK MODAL-->\n  <div class=\"modal fade\" id=\"createtankmodal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Add a New Aquarium</h5>\n      </div>\n      <div class=\"modal-body\">\n        <p>*You must complete all fields in order to create an aquarium.</p>\n  <form id=\"create-tank\">\n  <fieldset>\n    <legend>Create New Aquarium</legend>\n      <input name=\"tank[name]\" type=\"text\" id=\"create-tank-name\" maxlength=\"60\" placeholder=\"Aquarium Name\" required>\n      <select name=\"tank[water]\" id=\"create-tank-water\" required>\n        <option disabled selected value>--Choose a Water Type--</option>\n        <option value=\"Fresh\">Fresh</option>\n        <option value=\"Salt\">Salt</option>\n        <br>\n      </select>\n      <input type=\"submit\" name=\"submit\" value=\"Create New Aquarium\">\n  </fieldset>\n  </form>\n  </div>\n  <div class=\"modal-footer\">\n  <div class=\"createerror\"></div>\n  <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n  </div>\n  </div>\n  </div>\n  </div>\n  </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container no-tanks\">\n<h2>You currently have no aquariums. Click the 'Create New Aquarium!' button to add an aquarium.</h2>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateTank = function onCreateTank(event) {
	  // prevent screen from refreshing
	  event.preventDefault
	  // assign form field inputs to variable data
	  ();var data = getFormFields(this
	  // send ajax request to create a tank
	  );api.createTank(data).done(ui.createTankSuccess, getTanks).catch(ui.createTankFailure);
	};
	...
	var getTanks = function getTanks() {
	  ...
	  api.getTanks().then(ui.getTanksSuccess).catch(ui.getTanksFailure);
	};

	var onUpdateTank = function onUpdateTank(event) {
	  // prevent screen from refreshing
	  event.preventDefault
	  // assign data to be what user entered in form fields
	  ();var data = getFormFields(this
	  // assign data-id of item to the variable tankId
	  );var tankId = $(this).attr('data-id');
	  store.tank = tankId;
	  // pass goalID to the API Patch request for item
	  api.updateTank(tankId, data).then(ui.updateTankSuccess).catch(ui.updateTankFailure);
	};

	var onDeleteTank = function onDeleteTank() {
	  // prevent screen from refreshing
	  event.preventDefault
	  ...
	  api.deleteTank(data).then(ui.deleteTankSuccess).catch(ui.deleteTankFailure).done(getTanks);
	};

	var onShowOneTank = function onShowOneTank(event) {
	  // prevent screen from refreshing
	  event.preventDefault
	  // assign data value to be equal to the data-id of the item user wants to remove
	  ();var tankId = $(event.target).attr('data-id'
	  // pass data in delete request to api to delete item associated with ID
	  );api.getOneTank(tankId).done(ui.getOneTankSuccess).catch(ui.getOneTankFailure);
	};

	var refreshOneTank = function refreshOneTank() {
	  var tankId = store.tank;
	  // pass data in delete request to api to delete item associated with ID
	  api.getOneTank(tankId).then(ui.refreshOneTankSuccess).catch(ui.refreshOneTankFailure);
	};
	...
	var tankHandlers = function tankHandlers() {
	...
	module.exports = {
	  tankHandlers: tankHandlers,
	  onCreateTank: onCreateTank,
	  getTanks: getTanks,
	  onUpdateTank: onUpdateTank,
	  onShowOneTank: onShowOneTank,
	  refreshOneTank: refreshOneTank
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateAnimal = function onCreateAnimal(event) {
	  // prevent screen from refreshing
	  event.preventDefault
	  // assign form field inputs to variable data
	  ();var data = getFormFields(this
	  ...
	  api.createAnimal(tankId, data).then(ui.createAnimalSuccess).catch(ui.createAnimalFailure);
	};
	...
	var getAnimals = function getAnimals() {
	  ...
	  var tankId = store.tank;
	  // send request to API to get goals without an event trigger
	  api.getAnimals(tankId).then(ui.getAnimalsSuccess).catch(ui.getAnimalsFailure);
	};
	...
	var onUpdateAnimal = function onUpdateAnimal(event) {
	  ...
	  var animalId = $(event.target).attr('data-id'
	  // pass goalID to the API Patch request for item
	  );api.updateAnimal(tankId, animalId, data).then(ui.updateAnimalSuccess).catch(ui.updateAnimalFailure);
	};

	var onDeleteAnimal = function onDeleteAnimal() {
	  // prevent screen from refreshing
	  event.preventDefault
	  // get id from DOM and assign to tankId
	  ();var tankId = store.tank;
	  ...
	  var animalId = $(event.target).attr('data-id'
	  // pass data in delete request to api to delete item associated with ID
	  );api.deleteAnimal(tankId, animalId).done(ui.deleteAnimalSuccess).catch(ui.deleteAnimalFailure);
	};

	var animalHandlers = function animalHandlers() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createAnimal = function createAnimal(tankId, data) {
	  return $.ajax({
	...
	var getAnimals = function getAnimals(tankId) {
	  return $.ajax({
	    url: config.apiOrigin + '/tanks/' + tankId + '/animals',
	    method: 'GET',
	    headers: {
	...
	var deleteAnimal = function deleteAnimal(tankId, animalId) {
	  return $.ajax({
	...
	var updateAnimal = function updateAnimal(tankId, animalId, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/tanks/' + tankId + '/animals/' + animalId,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var listAnimalsTemplate = __webpack_require__(42);
	var noAnimalsTemplate = __webpack_require__(43);

	var createAnimalSuccess = function createAnimalSuccess(data) {
	...
	var createAnimalFailure = function createAnimalFailure() {
	...
	var getAnimalsSuccess = function getAnimalsSuccess(data) {
	  // if no animals - display message to user with handlebars templates
	  if (data.animals.length === 0) {
	    var noAnimals = noAnimalsTemplate();
	    ...
	    );var listAnimals = listAnimalsTemplate({ animals: data.animals }
	    // render handlebars template in div
	    );$('#handlebarstwo').html(listAnimals);
	  }
	};

	var getAnimalsFailure = function getAnimalsFailure() {};
	...
	var updateAnimalFailure = function updateAnimalFailure() {
	...
	var deleteAnimalFailure = function deleteAnimalFailure() {};

	module.exports = {
	  createAnimalSuccess: createAnimalSuccess,
	  createAnimalFailure: createAnimalFailure,
	  getAnimalsSuccess: getAnimalsSuccess,
	  getAnimalsFailure: getAnimalsFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr data-id=\""
	    ...
	    + "</td>\n      <td><button type=\"button\" class=\"update btn btn-primary handle update-animal-button\" data-toggle=\"modal\" data-target=\"#updateanimalmodal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update Animal</button></td>\n      <td><button type=\"button\" class=\"remove btn btn-danger handle\" data-toggle=\"modal\" data-target=\"#removeanimalmodal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete Animal</button></td>\n    </tr>\n</tbody>\n\n";
	},"3":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "    <div class=\"modal fade update-animal-modal\" id=\"updateanimalmodal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Update Animal Information</h5>\n          </div>\n          <div class=\"modal-body tank\" id=\""
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.tank : stack1)) != null ? stack1.id : stack1), depth0))
	    + "\">\n             <p>*You must complete all fields in order to update an animal.</p>\n            <form class=\"update-animal\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <fieldset>\n              <input type='text' name='animal[name]' id ='updateName' value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" maxlength=\"60\" placeholder=\"Updated Name\" required>\n              <input type='text' name='animal[species]' id ='updateSpecies' value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.species : stack1), depth0))
	    + "\" maxlength=\"60\" placeholder=\"Updated Species\" required>\n              <input type='text' name='animal[color]' id ='updateColor' value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.color : stack1), depth0))
	    + "\" maxlength=\"60\" placeholder=\"Updated Color\" required>\n                <hr>\n              <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Update Animal\">\n          </fieldset>\n          </form>\n          </div>\n          <div class=\"modal-footer\">\n            <div class=\"updateerror\"></div>\n            <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <div class=\"modal fade\" id=\"removeanimalmodal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLongTitle\" aria-hidden=\"true\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Are you sure you want to delete animal?</h5>\n          </div>\n          <div class=\"modal-body\">\n            <form class=\"remove-animal\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n              <fieldset>\n                <legend>Animal Name: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</legend>\n                <input type=\"submit\" name=\"submit\" value=\"Delete Animal\">\n              </fieldset>\n            </form>\n          </div>\n          <div class=\"modal-footer\">\n            <div class=\"passworderror\"></div>\n            <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n          </div>\n        </div>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

	  return "<div class=\"container text-center\">\n<table class=\"table table-bordered text-center animal-table\">\n  <thead class=\"text-center\">\n    <tr class=\"text-center\">\n      <th>Name</th>\n      <th>Species</th>\n      <th>Color</th>\n      <th>Update</th>\n      <th>Delete</th>\n    </tr>\n  </thead>\n\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.animals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </table>\n</div>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.animals : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container no-tanks\">\n<h2>You currently have no animals in your aquarium. Click the\n'Add Animal to this Aquarium' button to add an animal to your aquarium.</h2>\n</div>\n";
	},"useData":true});
